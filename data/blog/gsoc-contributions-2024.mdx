...
6. [#9311](https://github.com/aces/Loris/pull/9311) - [issue_tracker] Add Instrument dropdown to Issue form
7. [#9434](https://github.com/aces/Loris/pull/9434) - [issue_tracker] Convert batch/normal mode toggle to tabs and implement permission control

### Open Pull Requests

1. [#9425](https://github.com/aces/Loris/pull/9425) - [issue_tracker] Enable editing of site, assignee and watchers in Batch Mode
